...
% Init Theta and Run Gradient Descent 
theta4 = zeros(3, 1);
[theta4, J_history4] = gradientDescentMulti(X, y, theta4, alpha, num_iters);
...
%Best option is theta3, due to similarities with the reference curve, in
%the pdf given.
theta=theta3;
...
%where input is X in this case, [1 (1650-mu(1))/sigma(1) (3-mu(2))/sigma(2)]

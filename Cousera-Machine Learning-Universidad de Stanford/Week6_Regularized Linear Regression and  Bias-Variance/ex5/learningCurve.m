...
% Training error dafine as: J=coef.*((Hox-y)'*(Hox-y)).
% I dont use linearRegCostFunction.m  with lambda=0 because m change at
% every iteration.
...
for i=1:m
    ...
    coef=1/(2*i);
    Hox_tr=X(1:i, :)*theta;
    error_train(i)=coef.*((Hox_tr-y(1:i))'*(Hox_tr-y(1:i)));
